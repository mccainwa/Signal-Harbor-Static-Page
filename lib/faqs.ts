/**
 * FAQ content, shared by the interactive FAQ component and the FAQ page's
 * FAQPage structured data. Living in a plain module (not a client component)
 * keeps the data usable from server components.
 */
export const faqs = [
  {
    q: 'What is the complimentary AI Visibility Snapshot?',
    a: 'A brief preview of how AI platforms currently describe and recommend your company, included when you book an introductory call. It covers a limited prompt set with a short summary, and we walk through it together on the call. It is a preview, not the full audit.',
  },
  {
    q: 'How is the paid audit different from the Snapshot?',
    a: 'The AI Visibility Audit is a comprehensive paid engagement: a full prompt set, measurement across multiple AI platforms, competitor tracking, a source map, an accuracy review, and a prioritized action roadmap. The Snapshot is a quick preview that helps you decide whether the full audit is worth doing.',
  },
  {
    q: 'Is this SEO?',
  ...
  },
  {
    ...
    a: 'Pricing depends on prompt volume, the number of engines tested, reporting depth, implementation scope, and whether ongoing monitoring is included. We scope it on the introductory call. The call is free and the Snapshot that comes with it is complimentary.',
  },
  {
